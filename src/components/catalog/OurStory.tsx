...
export function OurStory() {
  ...
  return (
    <section id="nosotros" className="relative bg-[#f2eae6] py-24 overflow-hidden dark:bg-[#042430]">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        
        <div className="flex flex-col lg:flex-row items-center justify-center">
          
          {/* Tarjeta de Texto (Fondo) */}
          <div className="w-full lg:w-[45%] z-0 relative lg:-mr-12">
          ...
          <motion.div 
            ref={ref}
            style={{ clipPath }}
            className="w-full lg:w-[45%] relative h-[350px] lg:h-[450px] z-10 mt-[-3rem] lg:mt-0"
          >
            <video
